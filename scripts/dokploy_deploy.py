...
def env_text() -> str:
    ...
    return "\n".join(
        [
            ...
            f"ANOMALY_FAST_LANE_ENABLED={os.environ.get('ANOMALY_FAST_LANE_ENABLED', 'true')}",
            f"ANOMALY_FAST_INTERVAL={os.environ.get('ANOMALY_FAST_INTERVAL', '1h')}",
            f"ANOMALY_FAST_LOOKBACK_DAYS={os.environ.get('ANOMALY_FAST_LOOKBACK_DAYS', '365')}",
            f"ANOMALY_FAST_ROLLING_BARS={os.environ.get('ANOMALY_FAST_ROLLING_BARS', '168')}",
            f"ANOMALY_FAST_MIN_ABS_PCT_CHANGE={os.environ.get('ANOMALY_FAST_MIN_ABS_PCT_CHANGE', '1.0')}",
            f"ANOMALY_FAST_MIN_VOLUME_RATIO={os.environ.get('ANOMALY_FAST_MIN_VOLUME_RATIO', '3.0')}",
